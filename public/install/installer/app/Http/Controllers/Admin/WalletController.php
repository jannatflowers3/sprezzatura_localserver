...
//        $code                       = $this->codeGenerator($data);
    ...
    public function nagadVerify(Request $request, OfflineMethodInterface $offlineMethod, OrderInterface $order, \App\Repositories\Interfaces\Admin\Addon\WalletInterface $wallet)
    {
        $paymentController = new paymentController($order);
